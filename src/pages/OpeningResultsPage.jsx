...
const EXPORT_STATUS_META = {
  ...
  NOTICE_CONTEXT_PENDING: { color: "blue", label: "공고정보 수집 대기" },
  NOTICE_CONTEXT_RETRY: { color: "gold", label: "공고정보 재수집 대기" },
  NOTICE_CONTEXT_API_ERROR: { color: "orange", label: "공고 API 재확인 필요" },
  NOTICE_CONTEXT_NOT_FOUND: { color: "orange", label: "공식 공고 미발견" },
  NOTICE_CONTEXT_UNSUPPORTED: { color: "orange", label: "공고 유형 확인 필요" },
...
const BLOCK_REASON_LABELS = {
  ...
  bid_notice_context_pending: "공식 입찰공고 정보를 수집 대기 중입니다.",
  bid_notice_context_retry: "공식 입찰공고 정보를 다시 수집할 예정입니다.",
  bid_notice_context_api_error: "공식 입찰공고 API를 조회하지 못했습니다. 자동 재확인 후에도 실패했습니다.",
  bid_notice_context_not_found: "공식 입찰공고 API에서 공고번호·차수가 일치하는 정보를 찾지 못했습니다.",
  bid_notice_context_unsupported: "현재 이 공고 유형의 공식 공고 연결을 지원하지 않습니다.",
        ...
        <div className="opening-results-filter-row">
          ...
          <Select
            ...
            options={[
              ...
              { value: "NOTICE_CONTEXT_PENDING", label: "공고정보 수집 대기" },
              { value: "NOTICE_CONTEXT_RETRY", label: "공고정보 재수집 대기" },
              { value: "NOTICE_CONTEXT_API_ERROR", label: "공고 API 재확인 필요" },
              { value: "NOTICE_CONTEXT_NOT_FOUND", label: "공식 공고 미발견" },
              { value: "NOTICE_CONTEXT_UNSUPPORTED", label: "공고 유형 확인 필요" },
